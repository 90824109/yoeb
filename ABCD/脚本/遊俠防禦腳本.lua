...
SetNeedSkillLineData(20,"冰霜之捷,nil",50,nil,nil)
SetNeedSkillLineData(95,"元素淨化,nil|受傷時施放輔助,nil|信念浪湧,nil",nil,9,nil)
SetNeedSkillLineData(96,"堅定,nil|鋼筋鐵骨,nil|持續時間延長輔助,nil|物品稀有度增幅輔助,nil|連鎖輔助,nil|冰霜之刃,nil|憎恨,nil",nil,4,nil)
SetNeedSkillLineData(97,"盜獵者印記,nil|反抗之旗,nil|擊中時印記輔助,nil",nil,10,nil)
...
SetZhengTiColorVarData(2,0,4,0,nil,500,true)
SetZhengTiColorVarData(2,0,3,1,nil,450,true)
...
SetZhengTiColorVarData(10,1,1,0,nil,200,true)
